...
namespace VendaPues.Frontend.Pages.Suppliers
{
    ...
    public partial class SuppliersIndex
    {
        ...
        private async Task<TableData<Supplier>> LoadListAsync(TableState state, CancellationToken cancellationToken)
        {
        ...
        private async Task DeleteAsync(Supplier supplier)
        {
            ...
            await LoadAsync();
            await table.ReloadServerData();
            Snackbar.Add("Proveedor eliminado.", Severity.Success);
        }
    }
}